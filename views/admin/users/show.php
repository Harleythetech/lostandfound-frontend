            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 small">
                        <li class="breadcrumb-item"><a href="<?= APP_URL ?>/admin/users" class="text-decoration-none">Users</a></li>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body text-center py-4">
                        <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3" style="width: 64px; height: 64px; font-size: 1.5rem;">
                        ...
                        <div>
                            <span class="badge bg-<?= ($user['role'] ?? 'user') === 'admin' ? 'danger' : (($user['role'] ?? 'user') === 'security' ? 'warning' : 'secondary') ?>">
                    ...
                    <div class="card-body border-top small">
                        <p class="mb-2"><i class="bi bi-envelope me-2 text-muted"></i><?= htmlspecialchars($user['email'] ?? 'N/A') ?></p>
                        <p class="mb-2"><i class="bi bi-phone me-2 text-muted"></i><?= htmlspecialchars($user['contact_number'] ?? 'N/A') ?></p>
                        <p class="mb-0"><i class="bi bi-calendar me-2 text-muted"></i>Joined <?= formatDate($user['created_at'] ?? '') ?></p>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <?php if ($status === 'pending'): ?>
                            ...
                            <button type="button" class="btn btn-danger btn-sm w-100" data-bs-toggle="modal" data-bs-target="#declineModal">
            ...
            <form action="<?= APP_URL ?>/admin/users/<?= $user['id'] ?>/manage" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="reason" rows="3" required placeholder="Explain why this user is being suspended..."></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Duration (days)</label>
                        <input type="number" class="form-control" name="duration_days" min="1" placeholder="Leave empty for permanent suspension">
            ...
            <form action="<?= APP_URL ?>/admin/users/<?= $user['id'] ?>/manage" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="reason" rows="3" required placeholder="Explain why this registration is being declined..."></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
