...
<div class="admin-mobile-block">
    <div class="admin-mobile-block-content">
        ...
        <p class="text-muted mb-4">The Admin Panel is optimized for desktop use. Please access it from a computer or tablet for the best experience.</p>
...
<aside class="dashboard-sidebar" id="dashboardSidebar">
    ...
    <a href="<?= APP_URL ?>/admin" class="sidebar-brand">
        ...
        <small class="sidebar-brand-sub">Admin Panel | V1.0.0</small>
    </a>

    <!-- Navigation -->
    <nav class="sidebar-nav">
        <a href="<?= APP_URL ?>/admin" class="sidebar-link <?= $currentPath === 'admin' || $currentPath === 'admin/dashboard' ? 'active' : '' ?>">
            <i class="bi bi-speedometer2"></i>
            <span>Dashboard</span>
        </a>
        
        <a href="<?= APP_URL ?>/admin/pending" class="sidebar-link <?= strpos($currentPath, 'admin/pending') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= APP_URL ?>/admin/lost-items" class="sidebar-link <?= strpos($currentPath, 'admin/lost-items') !== false ? 'active' : '' ?>">
            <i class="bi bi-exclamation-triangle"></i>
            <span>Lost Items</span>
        </a>
        
        <a href="<?= APP_URL ?>/admin/found-items" class="sidebar-link <?= strpos($currentPath, 'admin/found-items') !== false ? 'active' : '' ?>">
            <i class="bi bi-box-seam"></i>
            <span>Found Items</span>
        </a>
        
        <a href="<?= APP_URL ?>/admin/claims" class="sidebar-link <?= strpos($currentPath, 'admin/claims') !== false ? 'active' : '' ?>">
            <i class="bi bi-hand-index"></i>
            <span>Claims</span>
        </a>
        
        <a href="<?= APP_URL ?>/admin/users" class="sidebar-link <?= strpos($currentPath, 'admin/users') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= APP_URL ?>/admin/categories" class="sidebar-link <?= strpos($currentPath, 'admin/categories') !== false ? 'active' : '' ?>">
            <i class="bi bi-tags"></i>
            <span>Categories</span>
        </a>
        
        <a href="<?= APP_URL ?>/admin/locations" class="sidebar-link <?= strpos($currentPath, 'admin/locations') !== false ? 'active' : '' ?>">
        ...
        <a href="<?= APP_URL ?>/admin/reports" class="sidebar-link <?= strpos($currentPath, 'admin/reports') !== false ? 'active' : '' ?>">
            <i class="bi bi-graph-up"></i>
            <span>Reports</span>
        </a>
        
        <a href="<?= APP_URL ?>/admin/activity" class="sidebar-link <?= strpos($currentPath, 'admin/activity') !== false ? 'active' : '' ?>">
        ...
        <div class="d-flex align-items-center justify-content-between w-100">
            <div class="d-flex align-items-center">
                ...
                <div class="sidebar-user-info">
                    <div class="sidebar-user-name"><?= htmlspecialchars(($sidebarUser['first_name'] ?? '') . ' ' . ($sidebarUser['last_name'] ?? '')) ?></div>
