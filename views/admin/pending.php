...
<div class="dashboard-wrapper">
    ...
    <main class="dashboard-main">
        ...
        <ul class="nav nav-pills mb-4">
            <li class="nav-item">
                <a class="nav-link <?= ($type ?? 'all') === 'all' ? 'active' : '' ?>" href="<?= APP_URL ?>/admin/pending?type=all">All</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($type ?? '') === 'lost' ? 'active' : '' ?>" href="<?= APP_URL ?>/admin/pending?type=lost">Lost Items</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?= ($type ?? '') === 'found' ? 'active' : '' ?>" href="<?= APP_URL ?>/admin/pending?type=found">Found Items</a>
            </li>
        </ul>
                        ...
                        <div class="card border-0 shadow-sm h-100">
                            ...
                            <div class="card-footer bg-transparent">
                                <div class="d-flex gap-2">
                                    <form action="<?= APP_URL ?>/admin/<?= $itemType ?>-items/<?= $itemId ?>/review" method="POST" class="flex-fill">
                                    ...
                                    <button type="button" class="btn btn-danger btn-sm flex-fill" 
                                            data-bs-toggle="modal" data-bs-target="#rejectModal<?= $itemId ?>">
