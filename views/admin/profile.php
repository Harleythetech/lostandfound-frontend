<?php $pageTitle = 'Admin Profile - ' . APP_NAME; ?>
    ...
    <main class="dashboard-main">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
            <div>
                ...
                <p class="text-muted mb-0 small">Manage your account and access admin tools</p>
            </div>
        ...
        <div class="row g-3">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="profileTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="info" role="tabpanel">
                                ...
                                <div id="viewMode">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <h6 class="mb-0"><i class="bi bi-person-circle me-2"></i>Account Information
                                        </h6>
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0 fw-medium">
                                                <?= htmlspecialchars($user['last_name'] ?? 'N/A') ?>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label text-muted small mb-1">School ID</label>
                                            <p class="mb-0 fw-medium">
                                                <?= htmlspecialchars($user['school_id'] ?? 'N/A') ?>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label text-muted small mb-1">Email Address</label>
                                            <p class="mb-0 fw-medium"><?= htmlspecialchars($user['email'] ?? 'N/A') ?>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0 fw-medium">
                                                <?= !empty($user['date_of_birth']) ? date('F j, Y', strtotime($user['date_of_birth'])) : 'N/A' ?>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0 fw-medium">
                                                <?= htmlspecialchars($user['year_level'] ?? 'N/A') ?>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div id="editMode" class="d-none">
                                    <form id="profileForm" onsubmit="submitProfileForm(event)">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control bg-light" id="school_id_display"
                                                    value="<?= htmlspecialchars($user['school_id'] ?? '') ?>" readonly
                                                    disabled>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                <label for="emergency_contact_name" class="form-label">Contact
                                                    Name</label>
                            ...
                            <div class="tab-pane fade" id="security" role="tabpanel">
                                ...
                                <form action="<?= APP_URL ?>/dashboard/profile/password" method="POST"
                                    autocomplete="off">
                                    <input type="text" name="prevent_autofill" id="prevent_autofill"
                                        style="display:none;" autocomplete="off">
                                    <input type="password" name="prevent_autofill_pass" id="prevent_autofill_pass"
                                        style="display:none;" autocomplete="off">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <input type="password" class="form-control" id="current_password"
                                                name="current_password" autocomplete="off" data-lpignore="true"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="password" class="form-control" id="new_password"
                                                name="new_password" minlength="8" autocomplete="off"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="password" class="form-control" id="confirm_password"
                                                name="confirm_password" autocomplete="off" data-lpignore="true"
                                                data-form-type="other" required>
                                        </div>
                                    </div>
                                    <div class="mt-4">
                            ...
                            <div class="tab-pane fade" id="notifications" role="tabpanel">
                                ...
                                <form action="<?= APP_URL ?>/notifications/preferences" method="POST">
                                    ...
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="match_notifications"
                                            name="match_notifications" <?= ($preferences['match_notifications'] ?? true) ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="match_notifications">
                                            <strong>Match Notifications</strong>
                                            <br><small class="text-muted">Get notified when potential matches are
                                                found</small>
                                        </label>
                                    </div>
                                    <div class="form-check form-switch mb-3">
                                        <input class="form-check-input" type="checkbox" id="claim_notifications"
                                            name="claim_notifications" <?= ($preferences['claim_notifications'] ?? true) ? 'checked' : '' ?>>
                                        <label class="form-check-label" for="claim_notifications">
                                            <strong>Claim Notifications</strong>
                                            <br><small class="text-muted">Get notified about claim status
                                                updates</small>
                                        </label>
                                    </div>
                                    <div class="mt-4">
            ...
            <div class="col-lg-5">
                <!-- Admin Widgets (reuse mini parts of admin dashboard) -->
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-header bg-white py-2">Quick Admin Stats</div>
                    <div class="card-body">
                        <?php
                        // Helper to display a stat
                        function render_stat($label, $value, $icon = 'bi-clipboard')
                        {
                            return '<div class="d-flex justify-content-between align-items-center py-2"><div><small class="text-muted">' . $label . '</small><div class="fw-semibold">' . intval($value) . '</div></div><div class="text-muted"><i class="bi ' . $icon . ' fs-4"></i></div></div>';
                        }

                        echo render_stat('Pending Lost Items', isset($stats['pending_lost_items']) ? count($stats['pending_lost_items']) : ($stats['pending_lost'] ?? 0), 'bi-exclamation-triangle');
                        echo '<hr/>';
                        echo render_stat('Pending Found Items', isset($stats['pending_found_items']) ? count($stats['pending_found_items']) : ($stats['pending_found'] ?? 0), 'bi-box-seam');
                        echo '<hr/>';
                        echo render_stat('Pending Claims', $stats['pending_claims_count'] ?? ($stats['pending_claims'] ?? 0), 'bi-clock-history');
                        ?>
                    </div>
                </div>

                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-header bg-white py-2">Quick Actions</div>
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="<?= APP_URL ?>/admin/pending" class="btn btn-outline-warning btn-sm">Review
                                Pending</a>
                            <a href="<?= APP_URL ?>/admin/claims?status=pending"
                                class="btn btn-outline-primary btn-sm">View Claims</a>
                            <a href="<?= APP_URL ?>/admin/users" class="btn btn-outline-secondary btn-sm">Manage
                                Users</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-2">Activity</div>
                    <div class="card-body p-3">
                        <p class="small text-muted">Recent activity and logs are available on the admin dashboard.</p>
                        <a href="<?= APP_URL ?>/admin/activity" class="btn btn-link p-0 small">View activity logs</a>
                    </div>
                </div>
            </div>
        </div>
