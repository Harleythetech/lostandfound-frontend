...
<div class="auth-split-container">
    ...
    <div class="auth-form-side">
        <div class="auth-form-wrapper">
            ...
            <!-- Firebase Sign-In -->
            <button type="button" class="btn btn-outline-secondary w-100 mb-3 firebase-btn"
            ...
            <form action="<?= APP_URL ?>/login" method="POST" id="loginForm">
                <div class="mb-2">
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <input type="text" class="form-control" id="school_id" name="school_id" placeholder="XX-XXXXX"
                            pattern="[A-Za-z0-9]{2}-[A-Za-z0-9]{5}" required>
                    </div>
                </div>
