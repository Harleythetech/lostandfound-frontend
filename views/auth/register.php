...
<div class="auth-split-container">
    ...
    <div class="auth-form-side auth-form-side-wide">
        <div class="auth-form-wrapper auth-form-wrapper-wide position-relative">
            ...
            <button type="button" class="btn btn-outline-secondary w-100 mb-2 firebase-btn"
                onclick="signUpWithGoogleForRegistration()">
            ...
            <form action="<?= APP_URL ?>/register" method="POST" id="registerForm">
                ...
                <div class="step-content" data-step="1">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <label for="school_id" class="form-label small mb-1">School ID <span
                            ...
                            <small class="text-muted" style="font-size: 0.7rem;">Format: XX-XXXXX (e.g.,
                                20-12345)</small>
                        </div>
                        <div class="col-md-6">
                            <label for="email" class="form-label small mb-1">Email Address <span
                                    class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                        ...
                        <div class="col-md-6">
                            <label for="password" class="form-label small mb-1">Password <span
                                    class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                            ...
                            <small class="text-muted" style="font-size: 0.7rem;">Minimum 8 characters, include
                                uppercase, lowercase, number</small>
                        </div>
                        <div class="col-md-6">
                            <label for="confirm_password" class="form-label small mb-1">Confirm Password <span
                                    class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                ...
                <div class="step-content d-none" data-step="2">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <label for="first_name" class="form-label small mb-1">First Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="first_name" name="first_name"
                                placeholder="Enter first name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="last_name" class="form-label small mb-1">Last Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="last_name" name="last_name"
                                placeholder="Enter last name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="contact_number" class="form-label small mb-1">Contact Number <span
                                    class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                        ...
                        <div class="col-md-6">
                            <label for="date_of_birth" class="form-label small mb-1">Date of Birth <span
                                    class="text-danger">*</span></label>
                            <input type="date" class="form-control form-control-sm" id="date_of_birth"
                                name="date_of_birth" required>
                        </div>
                        <div class="col-md-4">
                            <label for="gender" class="form-label small mb-1">Gender <span
                                    class="text-danger">*</span></label>
                ...
                <div class="step-content d-none" data-step="3">
                    ...
                    <div class="row g-2">
                        <div class="col-12">
                            <label for="address_line1" class="form-label small mb-1">Street Address <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label for="address_line2" class="form-label small mb-1">Barangay <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="address_line2"
                                name="address_line2" placeholder="Enter barangay" required>
                        </div>
                        <div class="col-md-6">
                            <label for="city" class="form-label small mb-1">City/Municipality <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="city" name="city"
                                placeholder="Enter city" required>
                        </div>
                        <div class="col-md-6">
                            <label for="province" class="form-label small mb-1">Province <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="province" name="province"
                                placeholder="Enter province" required>
                        </div>
                        <div class="col-md-6">
                            <label for="postal_code" class="form-label small mb-1">Postal Code <span
                                    class="text-danger">*</span></label>
                ...
                <div class="step-content d-none" data-step="4">
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <label for="emergency_contact_name" class="form-label small mb-1">Contact Name <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control form-control-sm" id="emergency_contact_name"
                                name="emergency_contact_name" placeholder="Full name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="emergency_contact_number" class="form-label small mb-1">Contact Number <span
                                    class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                                <span class="input-group-text"><i class="bi bi-phone"></i></span>
                                <input type="tel" class="form-control" id="emergency_contact_number"
                                    name="emergency_contact_number" placeholder="09XXXXXXXXX"
                                    pattern="^(09|\+639)[0-9]{9}$" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <label for="emergency_contact_relationship" class="form-label small mb-1">Relationship <span
                                    class="text-danger">*</span></label>
                            <select class="form-select form-select-sm" id="emergency_contact_relationship"
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('registerForm').addEventListener('submit', async function (e) {
            // Always ensure passwords match before submitting
            const pwd = document.getElementById('password')?.value || '';
            const confirm = document.getElementById('confirm_password')?.value || '';
            if (pwd !== confirm) {
                e.preventDefault();
                const confEl = document.getElementById('confirm_password');
                if (confEl) confEl.classList.add('is-invalid');
                if (typeof showAuthError === 'function') showAuthError('Passwords do not match');
                return;
            }
            ...
            if (firebaseToken) {
                ...
                // Field names already match backend (`address_line1`, `address_line2`)
