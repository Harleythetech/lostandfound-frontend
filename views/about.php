                ...
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-3">We understand how stressful it can be to lose something important, whether
                                it's your wallet, keys, phone, or precious documents.</p>
                            <p class="mb-0">Our mission is to create a simple, efficient, and free platform that
                                connects people who have lost items with those who have found them, fostering a helpful
                                and honest community.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4 mb-5">
        <div class="col-md-4">
            <div class="text-center p-4">
                ...
                <p class="text-muted small">Create a detailed report with photos and description of your lost or found
                    item.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="text-center p-4">
                ...
                <p class="text-muted small">Our system automatically matches lost items with found reports and notifies
                    you.</p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="text-center p-4">
                ...
                <p class="text-muted small">Verify ownership and coordinate with the finder to retrieve your belongings.
                </p>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">We believe in the power of community to help each
                        ...
                        <div class="col-md-6">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">Our platform is completely free to use for
                                        everyone, with no hidden charges.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">We respect your privacy and protect your personal
                                        data at all times.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">We keep things simple so anyone can report and find
                                        items quickly.</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm text-center">
                <div class="card-body p-5">
                    ...
                    <div class="mb-4">
                        <img src="<?= APP_URL ?>/assets/img/logo.png" alt="The South Devs" class="shadow-sm"
