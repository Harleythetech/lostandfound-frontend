...
<div class="dashboard-wrapper">
    ...
    <main class="dashboard-main">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-semibold mb-1"><i class="bi bi-exclamation-triangle-fill text-danger me-2"></i>Report Lost Item</h4>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="mb-3">
                                <label for="title" class="form-label">What did you lose? <span class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="3" 
                                          placeholder="Describe your item in detail - brand, color, size, contents, etc." required></textarea>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label for="last_seen_location_id" class="form-label">Last Seen Location <span class="text-danger">*</span></label>
                                    <select class="form-select" id="last_seen_location_id" name="last_seen_location_id" required>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="mb-0">
                                ...
                                <textarea class="form-control" id="unique_identifiers" name="unique_identifiers" rows="2" 
                                          placeholder="Any unique marks, scratches, stickers, engravings, serial numbers, etc."></textarea>
                                <div class="form-text"><i class="bi bi-shield-check me-1"></i>This helps verify ownership when someone finds your item</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" id="contact_via_email" name="contact_via_email" value="1" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="contact_via_phone" name="contact_via_phone" value="1">
                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body p-4">
                            ...
                            <div id="rewardAmountDiv" style="display: none;">
                                <label for="reward_offered" class="form-label">Amount</label>
                                <div class="input-group">
                                    <span class="input-group-text">₱</span>
                                    <input type="number" class="form-control" id="reward_offered" name="reward_offered" min="0" step="50" placeholder="0">
                                </div>
                            </div>
                        </div>
                    </div>
