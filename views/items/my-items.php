                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <img src="<?= APP_URL ?>/<?= htmlspecialchars($item['image']) ?>" class="rounded me-3" style="width: 40px; height: 40px; object-fit: cover;">
                                    <?php else: ?>
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <a href="<?= APP_URL ?>/items/<?= $item['id'] ?>" class="text-decoration-none fw-semibold">
                            ...
                            <td class="text-end">
                                <div class="btn-group btn-group-sm">
                                    <a href="<?= APP_URL ?>/items/<?= $item['id'] ?>" class="btn btn-outline-primary" title="View">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    <a href="<?= APP_URL ?>/items/<?= $item['id'] ?>/edit" class="btn btn-outline-secondary" title="Edit">
