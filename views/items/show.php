...
<div class="dashboard-wrapper">
    ...
    <main class="dashboard-main">
            ...
            <div>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 small">
                        <li class="breadcrumb-item"><a href="<?= APP_URL ?>/items" class="text-decoration-none">Items</a></li>
                        <li class="breadcrumb-item active"><?= htmlspecialchars($item['title'] ?? 'Item Details') ?></li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="d-flex align-items-start justify-content-between mb-4">
            <div>
                <div class="mb-2">
                    <span class="badge <?= ($item['status'] ?? '') === 'lost' ? 'bg-danger' : (($item['status'] ?? '') === 'found' ? 'bg-success' : 'bg-info') ?>">
                        <?= ucfirst($item['status'] ?? 'unknown') ?>
                    </span>
                    <span class="badge bg-secondary ms-1"><?= htmlspecialchars($item['category'] ?? 'Uncategorized') ?></span>
                </div>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <form action="<?= APP_URL ?>/items/<?= $item['id'] ?>/delete" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this item?');">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-sm">
                    ...
                    <img src="<?= APP_URL ?>/<?= htmlspecialchars($item['image']) ?>" class="card-img-top img-fluid" alt="<?= htmlspecialchars($item['title']) ?>" style="max-height: 400px; object-fit: cover;">
                    <?php else: ?>
            ...
            <div class="col-lg-7">
                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-0"><?= nl2br(htmlspecialchars($item['description'] ?? 'No description provided.')) ?></p>
                    </div>
                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-medium"><?= htmlspecialchars($item['location'] ?? 'Not specified') ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-medium"><?= date('M d, Y', strtotime($item['date_lost'])) ?></span>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-medium"><?= date('M d, Y', strtotime($item['date_found'])) ?></span>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="fw-medium"><?= date('M d, Y', strtotime($item['created_at'] ?? 'now')) ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    ...
                    If you found this item, please contact the owner using the contact information provided above or leave your contact details below.
                    <?php else: ?>
