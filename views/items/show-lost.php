                ...
                <div class="card border-0 shadow-sm">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <span class="badge bg-danger"><i class="bi bi-exclamation-triangle me-1"></i>Lost Item</span>
                        ...
                        <div class="row g-3 small">
                            ...
                            <div class="col-6">
                                ...
                                <span class="d-block fw-medium"><?= htmlspecialchars($item['location']['name'] ?? $item['last_seen_location'] ?? 'N/A') ?></span>
                            </div>
                            <div class="col-6">
                                <i class="bi bi-calendar text-success me-2"></i>
                                <span class="text-muted">Date Lost:</span>
                                <span class="d-block fw-medium"><?= formatDate($item['last_seen_date'] ?? $item['created_at']) ?></span>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="d-grid gap-2">
                            <?php if (isLoggedIn()): ?>
                                ...
                                <?php else: ?>
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#noContactModal">
                                    <i class="bi bi-chat-dots me-2"></i>Contact Owner
                                </button>
                                <?php endif; ?>
                            <?php else: ?>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border">
                            <div class="card-body p-3">
                                ...
                                <p class="small text-muted mb-2"><?= truncate($match['found_item']['description'] ?? '', 80) ?></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="badge bg-info"><?= $match['match_score'] ?? 0 ?>% Match</span>
                                    <a href="<?= APP_URL ?>/found-items/<?= $match['found_item']['id'] ?>" class="btn btn-sm btn-outline-primary">View</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="contactModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-muted small mb-3">Choose how you'd like to contact <?= htmlspecialchars($item['user']['first_name'] ?? 'the owner') ?>:</p>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm bg-light" value="<?= htmlspecialchars($item['email']) ?>" id="emailToCopy" readonly>
                            <button class="btn btn-outline-secondary btn-sm" type="button" onclick="copyToClipboard('emailToCopy', this)">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control form-control-sm bg-light" value="<?= htmlspecialchars($item['phone_number']) ?>" id="phoneToCopy" readonly>
                            <button class="btn btn-outline-secondary btn-sm" type="button" onclick="copyToClipboard('phoneToCopy', this)">
                                <i class="bi bi-clipboard"></i> Copy
                            </button>
                        </div>
                    </div>
