                ...
                <div class="card border">
                    <div class="card-body p-4">
                        <form action="<?= APP_URL ?>/items" method="POST" enctype="multipart/form-data">
                            <!-- Status Selection -->
                            <div class="mb-4">
                                <label class="form-label fw-semibold">What happened? <span
                                        class="text-danger">*</span></label>
                                <div class="row g-2">
                                    <div class="col-6">
                                        <input type="radio" class="btn-check" name="status" id="status_lost"
                                            value="lost" checked>
                                        <label class="btn btn-outline-danger w-100 py-3" for="status_lost">
                                            <i class="bi bi-exclamation-triangle d-block mb-1"
                                                style="font-size: 1.5rem;"></i>
                                            I Lost an Item
                                        </label>
                                    </div>
                                    <div class="col-6">
                                        <input type="radio" class="btn-check" name="status" id="status_found"
                                            value="found">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="title" class="form-label fw-semibold">Item Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="title" name="title"
                                        placeholder="e.g., Black iPhone 14 Pro" required>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="description" name="description" rows="3"
                                        placeholder="Describe distinguishing features, brand, color, etc."
                                        required></textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="location" name="location"
                                            placeholder="Where was it?" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label for="contact_info" class="form-label fw-semibold">Contact Info <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                            ...
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn btn-primary btn-lg"><i
                                        class="bi bi-check-circle me-2"></i>Submit Report</button>
