                        ...
                        <div id="viewMode">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="mb-0 fw-medium"><?= htmlspecialchars($user['contact_number'] ?? 'N/A') ?>
                                    </p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    <p class="mb-0 fw-medium"><?= htmlspecialchars($user['address_line1'] ?? 'N/A') ?>
                                    </p>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label text-muted small mb-1">Barangay</label>
                                    <p class="mb-0 fw-medium"><?= htmlspecialchars($user['address_line2'] ?? 'N/A') ?>
                                    </p>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="password" class="form-control" id="new_password" name="new_password"
                                        minlength="8" autocomplete="off" data-lpignore="true" data-form-type="other"
                                        required>
