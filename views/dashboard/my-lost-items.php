                                ...
                                <div class="col-8">
                                    <div class="card-body d-flex flex-column h-100">
                                        ...
                                        <div class="small text-muted mb-2">
                                            ...
                                            Lost:
                                            <?= date('M d, Y', strtotime($item['last_seen_date'] ?? $item['last_seen_date'] ?? $item['date_lost'] ?? $item['created_at'])) ?>
                                        </div>
                                        ...
                                        <?php if (!empty($item['reward_offered'] ?? $item['reward_offered'] ?? null)): ?>
                                            <div class="small text-success mb-2">
                                                ...
                                                Reward:
                                                ₱<?= number_format($item['reward_offered'] ?? $item['reward_offered'] ?? null, 2) ?>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="mt-auto">
                                            <div class="btn-group btn-group-sm w-100">
                                                ...
                                                <?php if ($status === 'pending' || $status === 'approved'): ?>
                                                    <a href="<?= APP_URL ?>/lost-items/<?= $item['id'] ?>/edit"
                                                        class="btn btn-outline-secondary">
                                                        <i class="bi bi-pencil"></i> Edit
                                                    </a>
                                                <?php endif; ?>
                                                <?php if ($status === 'matched'): ?>
                                                    <a href="<?= APP_URL ?>/dashboard/my-matches?item_id=<?= $item['id'] ?>"
