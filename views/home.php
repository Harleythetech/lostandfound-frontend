        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="how-it-works-card text-center p-4 h-100">
                    ...
                    <p class="text-muted small mb-0">Take a photo and describe the item you lost or found with location
                        details.</p>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card h-100 border-0 shadow-sm item-card-modern">
                            ...
                            <div class="card-body p-2">
                                <h6 class="card-title mb-1 text-truncate" title="<?= htmlspecialchars($item['title'] ?? '') ?>">
...
<!-- CTA Section -->
<section class="py-5 bg-custom-blue">
