                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <form action="<?= APP_URL ?>/notifications/mark-all-read" method="POST" class="d-inline">
                                <button type="submit" class="dropdown-item"><i class="bi bi-check-all me-2"></i>Mark all as read</button>
                            </form>
                        </li>
                        <li>
                            <form action="<?= APP_URL ?>/notifications/clear-read" method="POST" class="d-inline">
                                <button type="submit" class="dropdown-item text-danger"><i class="bi bi-trash me-2"></i>Clear read</button>
                            </form>
                        </li>
                    </ul>
                </div>
            ...
            <div class="list-group-item list-group-item-action <?= !$isRead ? 'bg-light' : '' ?>">
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-grow-1">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <?php if (!$isRead): ?>
                                        <li>
                                            <form action="<?= APP_URL ?>/notifications/<?= $notification['id'] ?>/read" method="POST">
                                                <button type="submit" class="dropdown-item"><i class="bi bi-check me-2"></i>Mark as read</button>
                                            </form>
                                        </li>
                                        <?php endif; ?>
                                        <li>
                                            <form action="<?= APP_URL ?>/notifications/<?= $notification['id'] ?>/delete" method="POST">
                        ...
                        <a href="<?= htmlspecialchars($notification['action_url']) ?>" class="btn btn-sm btn-outline-primary mt-2">
